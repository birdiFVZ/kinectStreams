...
namespace KinectStreams
{
    public static class Extensions
    {
        ...
        public static void DrawSkeleton(this Canvas canvas, Body body, bool write)
        {
            if (body == null) return;
        ...
        public static void WriteData(Joint joint)
        {
            string utcNow = DateTime.UtcNow.ToString("yyyy-MM-dd HH:mm:ss.fff");
            string jointXposition = joint.Position.X.ToString();
            string jointYposition = joint.Position.Y.ToString();
            string jointZposition = joint.Position.Z.ToString();
            string jointType = joint.JointType.ToString();
            string jointTrackingState = joint.TrackingState.ToString();
            ...
            StreamWriter file =
                new StreamWriter("C:\\Users\\Christoph\\CLionProjects\\skeletonAuthorization20112017\\data\\data.txt", true);
            file.WriteLine(line);
